...
# Función en Python para fondo estilizado Glassmorphism + Imagen Local
def aplicar_fondo_local(ruta_imagen):
    ...
    .stApp, p, label, h1, h2, h3, h4, span, div {{
        ...
        font-family: 'Trebuchet MS', -apple-system, BlinkMacSystemFont, sans-serif !important;
    }}
    ...
    /* Tarjetas y Columnas estilo Vidrio / Glassmorphism */
    ...
    /* Cajas de entrada e inputs con alto contraste */
